function R = huber_scatter(X, q, varargin)
% Huber's M-estimator of scatter (scale-free). Iterative fixed-point.
% X: MxK data (zero-mean assumed). c: tuning constant for Huber's loss.
% Returns MxM positive-definite matrix.
    p = inputParser;
